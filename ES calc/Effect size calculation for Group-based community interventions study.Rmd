...
Madigan2013_est <- 
  ...
  mutate(
    analysis_plan = case_when(
      ...
      str_detect(outcome, "Positive") ~ "Mental health outcomes",
      str_detect(outcome, "Negative") ~ "Mental health outcomes/Negative symptoms",
...
Morton2012_est <- 
  ...
  mutate(
    study = "Morton et al. 2012",
     ...
     analysis_plan = case_when(
      str_detect(outcome, "BEST|DASS") ~ "Mental health outcomes",
      str_detect(outcome, "BHS") ~ "Hope, Empowerment & Self-efficacy",
      str_detect(outcome, "DERS") ~ "Mental health outcomes/Unused outcomes",
      .default = NA_character_
    ),
  ...
  pp_cor_methods = "Obtained from test-retest reliability measures"
