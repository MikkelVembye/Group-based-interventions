...
Bækkelund2022_est <-           
  ...
  mutate(
    analysis_plan = c(
      "Global Assesment functioning (GAF)",
  ...
  mutate(
    ...
    vd_DD = (1/N_t + 1/N_c) * 2*(1-ppcor) + d_DD^2/(2*df), # skaber falsk korrelation, hvorfor vi beregner det store variansled
    ...
    vg_DD = (1/N_t + 1/N_c) * 2*(1-ppcor) + g_DD^2/(2*df), # variansen af den baseline adjusted effekstørrelse
    Wg_DD = Wd_DD,
