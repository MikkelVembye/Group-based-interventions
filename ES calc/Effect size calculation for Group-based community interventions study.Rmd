...
Rabenstein2015_est <-           
  ...
  mutate(
    ...
    mean_z =  (w_t*z_t + w_c*z_c)/(w_t + w_c),  
    ppcor = (exp(2*mean_z)-1)/(exp(2*mean_z)+1),
    pp_cor_methods = "Calculated from study results, i.e., paired t-tests",
...
Schrank2016_est <-           
  ...
  mutate(
    ...
    ppcor_calc_method = "Not computable - F value used for variance estimation",
