...
Craigie2009_est <- 
  ...
  mutate(
    ...
    # Average cluster size in treatment group
    # We calculate the average group size based on the knowledge 
    # that there was 50 group in the group-based arm
    avg_cl_size = 240/50, 
...
test_dat <- covariates |> 
  filter(str_detect(authors, "Bond")) |> 
  bind_cols(Bond2015_est)
