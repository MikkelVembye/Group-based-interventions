...
Dyck2000_est <-           
  Dyck2000_wide |>
  mutate(
    analysis_plan = "Negative Symptoms/Mental health outcomes",
...
Hagen2005_est <-           
  ...
  mutate(
    ...
    analysis_plan = case_when(
      ...
      str_detect(outcome, "BAI") ~ "Anxiety/Mental health outcomes",
      str_detect(outcome, "BDI") ~ "Depression/Mental health outcomes",
...
#  ),
  ...
  analysis_plan = case_when(
      ...
      str_detect(outcome, "Depression") ~ "Depression/Mental health outcomes",
  ...
  mutate(
   ...
   #    "the Sheehan Disability Scale (SDS)"),
    ...
    analysis_plan = case_when(
      ...
      str_detect(outcome, "Overall Anxiety Severity and Impairment scale") ~ "Anxiety/Mental health outcomes",
...
Lim2020 <- tibble(
  ...
  N = rep(c(18, 21), 6), #MHV Check this
