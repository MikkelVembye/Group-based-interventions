...
Hilden2021_est <-           
  ...
  mutate(
    analysis_plan = case_when(
      ...
      str_detect(outcome, "Overall Anxiety") ~ "Mental health outcomes/Anxiety",
...
McCay2006_est <- 
  tibble(
    ...
    analysis_plan = c(
      ...
      "Negative symptoms", "all mental health outcomes/Symptoms of psychosis"
      ),
...
dat_t <- # Not included in the covariaters sheet
  dat |> 
