---
title: "Publication bias testing in Dalgaard et al. (2026)"
...
PSM3_outcome_tab <- 
  tibble(
    ...
    est_ci = c(
      ...
      NA_character_,
      as.character(round(unique(mod_3PSM_outcome$predictions$lambda_full[,2]), 3)),
      NA_character_,
...
PSM4_outcome_tab <- 
  tibble(
    ...
    est_ci = c(
      ...
      NA_character_,
      as.character(round(unique(mod_4PSM_outcome$predictions$lambda_full[,2]), 3)),
      as.character(round(unique(mod_4PSM_outcome$predictions$lambda_full[,3]), 3)),
...
```{r reint-overall-fp-cano-mental}
...
PSM3_outcome_tab_mental <- 
  tibble(
    ...
    est_ci = c(
      ...
      NA_character_,
      as.character(round(unique(mod_3PSM_outcome_mental$predictions$lambda_full[,2]), 3)),
      NA_character_,
...
PSM4_outcome_tab_mental <- 
  tibble(
    ...
    est_ci = c(
      ...
      NA_character_,
      as.character(round(unique(mod_4PSM_outcome_mental$predictions$lambda_full[,2]), 3)),
      as.character(round(unique(mod_4PSM_outcome_mental$predictions$lambda_full[,3]), 3)),
...
ylab <- es_level_fp_mental_nhb$labels$x

es_level_fp_nhb$labels$x <- es_level_fp_mental_nhb$labels$x <- "" 

#png("Figures/funnel plots (overall effect) across type of registration NHB.png", width = 6.5, height = 5, res = 300, unit = "in")
es_level_fp_nhb  / es_level_fp_mental_nhb
grid::grid.draw(grid::textGrob(ylab, y = 0.6, x = 0.02, rot = 90))
#dev.off()
