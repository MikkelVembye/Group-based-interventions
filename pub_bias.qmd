...
# **Reintegration**
[label](https://www.pnascentral.org/cgi-bin/main.plex?form_type%3Dcontinue_halted_submission%26j_id%3D1%26ms_id%3D719859%26ms_rev_no%3D0%26ms_id_key%3Dftd4bBU3zVOeDlsXu15u4QTw)
## Data
```{r load-data}
#| code-fold: false
...
```{r pub-bias-plot-prereg-reint-mental}
