...
::: {.cell-output-display}
![RoB2 plot for reintegration studies and outcomes across type of registration (raw numbers)](Sensitivity-analyses_files/figure-html/fig-rob2-reint-raw-number-1.png){#fig-rob2-reint-raw-number fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for reintegration studies and outcomes across type of registration (weighted percentage)](Sensitivity-analyses_files/figure-html/fig-rob2-reint-weigthed-1.png){#fig-rob2-reint-weigthed fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for reintegration studies and outcomes across type of registration (unweighted percentage)](Sensitivity-analyses_files/figure-html/fig-rob2-reint-unweigthed-1.png){#fig-rob2-reint-unweigthed fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for mental health studies and outcomes across type of registration (raw numbers)](Sensitivity-analyses_files/figure-html/fig-rob2-mental-raw-number-1.png){#fig-rob2-mental-raw-number fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for mental health studies and outcomes across type of registration (weighted percentage)](Sensitivity-analyses_files/figure-html/fig-rob2-mental-weigthed-1.png){#fig-rob2-mental-weigthed fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for mental health studies and outcomes across type of registration (unweighted percentage)](Sensitivity-analyses_files/figure-html/fig-rob2-mental-unweigthed-1.png){#fig-rob2-mental-unweigthed fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for reintegration studies and outcomes by type of registration and outcome (number of studies)](Sensitivity-analyses_files/figure-html/fig-rob2-reint-n-studies-subgroup-1.png){#fig-rob2-reint-n-studies-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for reintegration studies and outcomes by type of registration and outcome (weighted percentage of studies)](Sensitivity-analyses_files/figure-html/fig-rob2-reint-weigthed-subgroup-1.png){#fig-rob2-reint-weigthed-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for reintegration studies and outcomes by type of registration and outcome (unweighted percentage of studies)](Sensitivity-analyses_files/figure-html/fig-rob2-reint-unweigthed-subgroup-1.png){#fig-rob2-reint-unweigthed-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for reintegration studies and outcomes by type of registration and outcome (number of effects)](Sensitivity-analyses_files/figure-html/fig-rob2-reint-n-effects-subgroup-1.png){#fig-rob2-reint-n-effects-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for reintegration studies and outcomes by type of registration and outcome (weighted percentage of effects)](Sensitivity-analyses_files/figure-html/fig-rob2-reint-weigthed-effects-subgroup-1.png){#fig-rob2-reint-weigthed-effects-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for reintegration studies and outcomes by type of registration and outcome (unweighted percentage of effects)](Sensitivity-analyses_files/figure-html/fig-rob2-reint-unweigthed-effects-subgroup-1.png){#fig-rob2-reint-unweigthed-effects-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for mental studies and outcomes by type of registration and outcome (number of studies)](Sensitivity-analyses_files/figure-html/fig-rob2-mental-n-studies-subgroup-1.png){#fig-rob2-mental-n-studies-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for mental health studies and outcomes by type of registration and outcome (weighted percentage of studies)](Sensitivity-analyses_files/figure-html/fig-rob2-mental-weigthed-subgroup-1.png){#fig-rob2-mental-weigthed-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for mental health studies and outcomes by type of registration and outcome (unweighted percentage of studies)](Sensitivity-analyses_files/figure-html/fig-rob2-mental-unweigthed-subgroup-1.png){#fig-rob2-mental-unweigthed-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for mental studies and outcomes by type of registration and outcome (number of effects)](Sensitivity-analyses_files/figure-html/fig-rob2-mental-n-effects-subgroup-1.png){#fig-rob2-mental-n-effects-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for mental health studies and outcomes by type of registration and outcome (weighted percentage of effects)](Sensitivity-analyses_files/figure-html/fig-rob2-mental-weigthed-effects-subgroup-1.png){#fig-rob2-mental-weigthed-effects-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![RoB2 plot for mental health studies and outcomes by type of registration and outcome (unweighted percentage of effects)](Sensitivity-analyses_files/figure-html/fig-rob2-mental-unweigthed-effects-subgroup-1.png){#fig-rob2-mental-unweigthed-effects-subgroup fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![ROBINS-I plot for reintegration QES studies and outcomes (raw number)](Sensitivity-analyses_files/figure-html/fig-rob2-robins-i-raw-1.png){#fig-rob2-robins-i-raw fig-pos='H' width=1152}
:::
:::
...
::: {.cell-output-display}
![ROBINS-I plot for reintegration QES studies and outcomes (weighted percentage)](Sensitivity-analyses_files/figure-html/fig-rob2-robins-i-weigthed-1.png){#fig-rob2-robins-i-weigthed fig-pos='H' width=1152}
:::
:::
...
::: {.cell-output-display}
![ROBINS-I plot for reintegration QES studies and outcomes (unweighted percentage)](Sensitivity-analyses_files/figure-html/fig-rob2-robins-i-unweigthed-1.png){#fig-rob2-robins-i-unweigthed fig-pos='H' width=1152}
:::
:::
...
::: {.cell-output-display}
![ROBINS-I plot for mental health QES studies and outcomes (raw number)](Sensitivity-analyses_files/figure-html/fig-rob2-robins-i-raw-mental-1.png){#fig-rob2-robins-i-raw-mental fig-pos='H' width=1152}
:::
:::
...
::: {.cell-output-display}
![ROBINS-I plot for mental health QES studies and outcomes (weighted percentage)](Sensitivity-analyses_files/figure-html/fig-rob2-robins-i-weigthed-mental-1.png){#fig-rob2-robins-i-weigthed-mental fig-pos='H' width=1152}
:::
:::
...
::: {.cell-output-display}
![ROBINS-I plot for mental health QES studies and outcomes (unweighted percentage)](Sensitivity-analyses_files/figure-html/fig-rob2-robins-i-unweigthed-mental-1.png){#fig-rob2-robins-i-unweigthed-mental fig-pos='H' width=1152}
:::
:::
...
::: {.cell-output-display}
![Number of studies included in meta-analysis by year.](Sensitivity-analyses_files/figure-html/fig-time-plot-1.png){#fig-time-plot fig-pos='H' width=1152}
:::
:::
...
::: {.cell-output-display}
![Distribution of number of effect size estimates per study](Sensitivity-analyses_files/figure-html/fig-es-hist-per-stud-1.png){#fig-es-hist-per-stud fig-pos='H' width=624}
:::
:::
...
::: {.cell-output-display}
![Distribution of number of effects per study, by direction of the effects for reintegrational outcomes.](Sensitivity-analyses_files/figure-html/fig-es-hist-per-stud-reint-1.png){#fig-es-hist-per-stud-reint fig-pos='H' width=1152}
:::
:::
...
::: {.cell-output-display}
![Distribution of number of effects per study, by direction of the effects for mental health outcomes.](Sensitivity-analyses_files/figure-html/fig-es-hist-per-stud-mental-1.png){#fig-es-hist-per-stud-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of number of effect size estimates per study](Sensitivity-analyses_files/figure-html/fig-es-hist-1.png){#fig-es-hist fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![Distribution of number of effects per study for mental for reintegrational outcomes.](Sensitivity-analyses_files/figure-html/fig-es-hist-reint-1.png){#fig-es-hist-reint fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![Distribution of number of effects per study for mental health outcomes.](Sensitivity-analyses_files/figure-html/fig-es-hist-mental-1.png){#fig-es-hist-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by reintegrational outcome constructs.](Sensitivity-analyses_files/figure-html/fig-outcome-construct-ridge-hist-1.png){#fig-outcome-construct-ridge-hist fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by mental health outcome constructs.](Sensitivity-analyses_files/figure-html/fig-outcome-construct-ridge-hist-mental-1.png){#fig-outcome-construct-ridge-hist-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of primary study sample sizes at post test for reintegrational outcomes.](Sensitivity-analyses_files/figure-html/fig-sample-size-reint-1.png){#fig-sample-size-reint fig-pos='H' width=768}
:::
:::
...
::: {.cell-output-display}
![Distribution of primary study sample sizes at post test for mental health outcomes.](Sensitivity-analyses_files/figure-html/fig-sample-size-mental-1.png){#fig-sample-size-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of treatment sample sizes at post test for reintegrational outcomes.](Sensitivity-analyses_files/figure-html/fig-sample-size-treatment-reint-1.png){#fig-sample-size-treatment-reint fig-pos='H' width=768}
:::
:::
...
::: {.cell-output-display}
![Distribution of treatment sample sizes at post test for mental health outcomes.](Sensitivity-analyses_files/figure-html/fig-sample-size-treatment-mental-1.png){#fig-sample-size-treatment-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of control group sample sizes at post test for reintegrational outcomes.](Sensitivity-analyses_files/figure-html/fig-sample-size-control-reint-1.png){#fig-sample-size-control-reint fig-pos='H' width=768}
:::
:::
...
::: {.cell-output-display}
![Distribution of control group sample sizes at post test for mental health outcomes.](Sensitivity-analyses_files/figure-html/fig-sample-size-control-mental-1.png){#fig-sample-size-control-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Study sample sizes versus number of effect size estimates for reintegrational outcomes](Sensitivity-analyses_files/figure-html/fig-es-distribution-bivariate-1.png){#fig-es-distribution-bivariate fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by reintegrational outcomes](Sensitivity-analyses_files/figure-html/fig-type-ridge-reint-analyzed-1.png){#fig-type-ridge-reint-analyzed fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by reintegrational outcomes.](Sensitivity-analyses_files/figure-html/fig-type-ridge-reint-not-analyzed-1.png){#fig-type-ridge-reint-not-analyzed fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by mental health outcomes.](Sensitivity-analyses_files/figure-html/fig-type-ridge-mental-analyzed-1.png){#fig-type-ridge-mental-analyzed fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Network structure of contrasts between primary and secondary outcome constructs](Sensitivity-analyses_files/figure-html/fig-network-1.png){#fig-network fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by diagnosis (reintegrational outcome).](Sensitivity-analyses_files/figure-html/fig-diagnosis-ridge-reint-1.png){#fig-diagnosis-ridge-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by diagnosis (mental health).](Sensitivity-analyses_files/figure-html/fig-type-ridge-mental-1.png){#fig-type-ridge-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by type of intervention (reintegrational outcome).](Sensitivity-analyses_files/figure-html/fig-cbt-ridge-reint-1.png){#fig-cbt-ridge-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by type of intervention (mental health).](Sensitivity-analyses_files/figure-html/fig-cbt-ridge-mental-1.png){#fig-cbt-ridge-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![EGM for reintegrational outcomes](Sensitivity-analyses_files/figure-html/fig-egm-reint-1.png){#fig-egm-reint fig-pos='H' width=1728}
:::
:::
...
::: {.cell-output-display}
![EGM for mental health outcomes](Sensitivity-analyses_files/figure-html/fig-egm-mental-1.png){#fig-egm-mental fig-pos='H' width=1728}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by type of test (reintegrational outcome).](Sensitivity-analyses_files/figure-html/fig-test-type-ridge-reint-1.png){#fig-test-type-ridge-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by type of test (mental health).](Sensitivity-analyses_files/figure-html/fig-test-type-ridge-mental-1.png){#fig-test-type-ridge-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distributions of effect size by p values and outcome measure type.](Sensitivity-analyses_files/figure-html/fig-es-pval-reint-1.png){#fig-es-pval-reint fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by estiamtion strategy (reintegrational outcome).](Sensitivity-analyses_files/figure-html/fig-strategy-ridge-reint-1.png){#fig-strategy-ridge-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by estiamtion strategy (mental health).](Sensitivity-analyses_files/figure-html/fig-strategy-ridge-mental-1.png){#fig-strategy-ridge-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by research design (reintegrational outcome).](Sensitivity-analyses_files/figure-html/fig-design-ridge-reint-1.png){#fig-design-ridge-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by research design (mental health).](Sensitivity-analyses_files/figure-html/fig-design-ridge-mental-1.png){#fig-design-ridge-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by type of control group (reintegrational outcome).](Sensitivity-analyses_files/figure-html/fig-control-ridge-reint-1.png){#fig-control-ridge-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by type of control group (mental health).](Sensitivity-analyses_files/figure-html/fig-control-ridge-mental-1.png){#fig-control-ridge-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by overall risk of bias assessment (reintegrational outcome).](Sensitivity-analyses_files/figure-html/fig-rob-ridge-reint-1.png){#fig-rob-ridge-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by overall risk of bias assessment (mental health).](Sensitivity-analyses_files/figure-html/fig-rob-ridge-mental-1.png){#fig-rob-ridge-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by type of registration (reintegrational outcome).](Sensitivity-analyses_files/figure-html/fig-prereg-ridge-reint-1.png){#fig-prereg-ridge-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by type of registration (mental health).](Sensitivity-analyses_files/figure-html/fig-prereg-ridge-mental-1.png){#fig-prereg-ridge-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of effect size estimates, by risk of bias assessemnt across outcomes and registration (mental health).](Sensitivity-analyses_files/figure-html/fig-prereg-rob-ridge-mental-1.png){#fig-prereg-rob-ridge-mental fig-pos='H' width=864}
:::
:::
...
::: {.cell-output-display}
![Distribution of average age in a study (reintegrational).](Sensitivity-analyses_files/figure-html/fig-age-density-reint-1.png){#fig-age-density-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution of average age in a study (mental health).](Sensitivity-analyses_files/figure-html/fig-age-density-mental-1.png){#fig-age-density-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution proportion of males in each study (reintegration).](Sensitivity-analyses_files/figure-html/fig-males-density-reint-1.png){#fig-males-density-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Distribution proportion of males in each study (mental health).](Sensitivity-analyses_files/figure-html/fig-males-density-mental-1.png){#fig-males-density-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of study sessions (reintegration).](Sensitivity-analyses_files/figure-html/fig-sessions-hist-reint-1.png){#fig-sessions-hist-reint fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of study sessions (mental health).](Sensitivity-analyses_files/figure-html/fig-sessions-hist-mental-1.png){#fig-sessions-hist-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Length of intervention in weeks (reintegration)](Sensitivity-analyses_files/figure-html/fig-duration-reint-1.png){#fig-duration-reint fig-pos='H' width=652.8}
:::
:::
...
::: {.cell-output-display}
![Length of intervention in weeks (mental health)](Sensitivity-analyses_files/figure-html/fig-duration-mental-1.png){#fig-duration-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Weeks after end of interventions for all studies (reintegration)](Sensitivity-analyses_files/figure-html/fig-follow-up-connected-reint-1.png){#fig-follow-up-connected-reint fig-pos='H' width=624}
:::
:::
...
::: {.cell-output-display}
![Weeks after end of interventions for all studies (mental health)](Sensitivity-analyses_files/figure-html/fig-follow-up-connected-mental-1.png){#fig-follow-up-connected-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Length of intervention in weeks (reintegration)](Sensitivity-analyses_files/figure-html/fig-es-time-reint-1.png){#fig-es-time-reint fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Length of intervention in weeks (mental health)](Sensitivity-analyses_files/figure-html/fig-es-time-mental-1.png){#fig-es-time-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Multivariate structure between substaintial/theoretical categorical and continuous (reintegration)](Sensitivity-analyses_files/figure-html/fig-multivariate-plot-reint-1.png){#fig-multivariate-plot-reint fig-pos='H' width=2304}
:::
:::
...
::: {.cell-output-display}
![Multivariate structure between substaintial/theoretical categorical and continuous covariates (mental health)](Sensitivity-analyses_files/figure-html/fig-multivariate-plot-mental-1.png){#fig-multivariate-plot-mental fig-pos='H' width=2304}
:::
:::
...
::: {.cell-output-display}
![Multivariate structure between methodological categorical and continuous covariates (reintegration)](Sensitivity-analyses_files/figure-html/fig-multivariate-plot-reint-method-1.png){#fig-multivariate-plot-reint-method fig-pos='H' width=2304}
:::
:::
...
::: {.cell-output-display}
![Multivariate structure between methodological categorical and continuous (mental health)](Sensitivity-analyses_files/figure-html/fig-multivariate-plot-mental-method-1.png){#fig-multivariate-plot-mental-method fig-pos='H' width=2304}
:::
:::
...
::: {.cell-output-display}
![Multivariate structure between substantial and methodological categorical covariates (reintegration)](Sensitivity-analyses_files/figure-html/fig-multivariate-plot-reint-method-theoretical-1.png){#fig-multivariate-plot-reint-method-theoretical fig-pos='H' width=2304}
:::
:::
...
::: {.cell-output-display}
![Multivariate structure between substantial and methodological categorical covariates (mental health)](Sensitivity-analyses_files/figure-html/fig-multivariate-plot-mental-method-theoretical-1.png){#fig-multivariate-plot-mental-method-theoretical fig-pos='H' width=2304}
:::
:::
...
::: {.cell-output-display}
![Forest plot of standard error of reintegrational effect size estimates.](Sensitivity-analyses_files/figure-html/fig-forset-plot-se-1.png){#fig-forset-plot-se fig-pos='H' width=652.8}
:::
:::
...
::: {.cell-output-display}
![Forest plot of standard error of mental health effect size estimates.](Sensitivity-analyses_files/figure-html/fig-forset-plot-se-mental-1.png){#fig-forset-plot-se-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Forest plot of modified standard error of reintegrational effect size estimates.](Sensitivity-analyses_files/figure-html/fig-forset-plot-se-modified-1.png){#fig-forset-plot-se-modified fig-pos='H' width=652.8}
:::
:::
...
::: {.cell-output-display}
![Forest plot of modified standard error of mental health effect size estimates.](Sensitivity-analyses_files/figure-html/fig-forset-plot-se-mental-modified-1.png){#fig-forset-plot-se-mental-modified fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Plot of inverse sampling covariance (ISC) weights for each study (reintegrational outcomes)](Sensitivity-analyses_files/figure-html/fig-iscw-1.png){#fig-iscw fig-pos='H' width=652.8}
:::
:::
...
::: {.cell-output-display}
![Plot of inverse sampling covariance (ISC) weights for each study (mental healt outcomes)](Sensitivity-analyses_files/figure-html/fig-iscw-mental-1.png){#fig-iscw-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Study sample sizes versus reintegrational standard error estimates](Sensitivity-analyses_files/figure-html/fig-sample-vs-se-1.png){#fig-sample-vs-se fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Study sample sizes versus mental health standard error estimates](Sensitivity-analyses_files/figure-html/fig-sample-vs-se-mental-1.png){#fig-sample-vs-se-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Standard error vs. modified standard errors (reintegration)](Sensitivity-analyses_files/figure-html/fig-se-vs-scaled-1.png){#fig-se-vs-scaled fig-pos='H' width=576}
:::
:::
...
::: {.cell-output-display}
![Standard error vs. modified standard errors (mental health outcomes)](Sensitivity-analyses_files/figure-html/fig-se-vs-scaled-mental-1.png){#fig-se-vs-scaled-mental fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Empirical distribution of effect size estimates, by reintegrational constructs](Sensitivity-analyses_files/figure-html/fig-es-distribution-reint-subgroup-1.png){#fig-es-distribution-reint-subgroup fig-pos='H' width=672}
:::
:::
...
::: {.cell-output-display}
![Empirical distribution of effect size estimates, by mental health constructs](Sensitivity-analyses_files/figure-html/fig-es-distribution-mental-subgroup-1.png){#fig-es-distribution-mental-subgroup fig-pos='H' width=672}
:::
:::
