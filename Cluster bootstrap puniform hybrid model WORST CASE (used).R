...
reint_dat <- readRDS("Data/worst_dat_reint.RDS")
...
saveRDS(boots_overall, "Bootstrap results/boots_overall_reint_worst.rds")
saveRDS(hyema_overall, file = "Bootstrap results/hyema_overall_reint_worst.rds")
...
# Make it work on the reintegration data
mental_dat <- readRDS("Data/worst_dat_mental.RDS")
