...
################################################################################
.SCE_RVE <- 
  function(formula, es, var, rand, structure, rho, data, model, table, R, seed, return_rma_obj = FALSE){
  ...
  raw_res$call$yi <- as(raw_res$call$yi, Class = "call") 
...
tic()
x_test <- future_pmap(.l = arg_list_tbl_rho08[1,], .f = .SCE_RVE, return_rma_obj = FALSE, .options = opts); x_test
toc()
