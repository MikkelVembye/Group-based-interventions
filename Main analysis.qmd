  ...
  tibble::tibble(
    ...
    covars = rep(
      c(
        "age_c", 
        paste0(
          "age_c;outcome_type;schizo_c;cbt_c;prereg_c;clinical_c;tot_c;qes_c;crt_grp_c;",
          "male_c;sessions_c;duration_c;fu_time_c"
        ),
        
        "male_c",
        paste0(
          "male_c;schizophrenia_in_sample;alcohol;hope;lonely;self_est;social_fun;wellbeing;other;",
          "cbt_c;prereg_c;clinical_c;tot_c;qes_c;crt_grp_c;",
        ...
        "sessions_c",
        paste0(
          "sessions_c;CBT_intervention;alcohol;hope;lonely;self_est;social_fun;wellbeing;other;",
          "schizo_c;prereg_c;clinical_c;tot_c;qes_c;crt_grp_c;",
          "age_c;male_c;duration_c;fu_time_c"
        ),
        
        "duration_c", 
        paste0(
          "duration_c;prereg_chr;alcohol;hope;lonely;self_est;social_fun;wellbeing;other;",
          "schizo_c;cbt_c;clinical_c;tot_c;qes_c;crt_grp_c;", 
          "age_c;male_c;sessions_c;fu_time_c"
        ),
        
        "fu_time_c",
        paste0(
          "fu_time_c;test_type;alcohol;hope;lonely;self_est;social_fun;wellbeing;other;",
          "schizo_c;cbt_c;prereg_c;tot_c;qes_c;crt_grp_c;", 
          "age_c;male_c;sessions_c;duration_c"
        )
...
z_text <- pmap(.l = tbl_test, .f = .CHE_meta_reg, return_rma_obj = FALSE)    
