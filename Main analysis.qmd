...
#PI
c(main_res_reint$pi_lb_80, main_res_reint$pi_ub_80)
...
# -----------------------------
x_vals <- rnorm(10000, mean = mu, sd = pred_sd)

dens_df <- data.frame(
  x = x_vals,
  y = dnorm((x_vals - mu) / pred_sd) / pred_sd
)
...
ggplot(aes(x, y)) +
 ...
 annotate("segment",
  ...
  labs(
    caption = paste0("Effects above null ", round(prop_above0, 2), "%."),
...
#PI
c(main_res_mental$pi_lb_80, main_res_mental$pi_ub_80)
